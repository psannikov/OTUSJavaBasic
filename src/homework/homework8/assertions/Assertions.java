package homework.homework8.assertions;
...
public class Assertions {
    ...
    public static void assertBiggerMax(int expected, int actual) {
        if (actual > expected) {
            throw new AssertionError(String.format("Expected %d <= %d", expected, actual));
        }
    }
    public static void assertLowerMin(int expected, int actual) {
        if (actual < expected) {
            throw new AssertionError(String.format("Expected %d >= %d", expected, actual));
        }
    }
